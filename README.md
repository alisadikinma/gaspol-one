...
| [gaspol-jobhunter](https://github.com/alisadikinma/gaspol-jobhunter) | 0.2.0 | 6 skills for job hunting — build a sourced master CV (PDF, notes, sites), discover and score roles, then tailor a CV and cover letter to one job description: every requirement is mapped to evidence and agreed with you before anything is written, gaps are never invented, output is an ATS-readable PDF. Never auto-applies. |
