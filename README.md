...
| [gaspol-catalog](https://github.com/alisadikinma/gaspol-catalog) | 0.1.0 | 4 skills for B2B sales catalogs and offer decks — master catalog once, per-prospect variants many times, two-layer text + rendered-image gate. |
